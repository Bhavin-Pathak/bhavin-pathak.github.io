...
export function LiquidContainer({ children, className = "", delay = 0 }) {
    return (
        <motion.div
            ...
            transition={{ duration: 0.6, delay, ease: [0.22, 1, 0.36, 1] }} // iOS-like spring ease
            className={`relative transform-gpu backdrop-blur-xl saturate-150 bg-black/5 dark:bg-black/40 
